    ...
    <div className="bg-white bg-gradient-to-t from-white via-[#ffe7d3] to-white py-20">
      <div className=" flex justify-center items-start flex-col px-[5%]">
        <h2 className="md:text-8xl text-3xl font-bold">
          What is{" "}
          <span className="textaboutus">
            Technovators
          </span>{" "}
          ?
        </h2>
        <p className="mt-8 md:text-[2rem] font-light text-gray-800">
          ...
          <br />
          <br />
          Through our flagship Uhack series and
          other events, we provide a platform for learning, innovation, and
          growth, empowering individuals to shape the future of technology. Our
          vibrant community is dedicated to fostering a culture of
